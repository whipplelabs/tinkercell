...
*tc_getFromList = *tinkercellc::tc_getFromList;
...
*tc_getColorR = *tinkercellc::tc_getColorR;
*tc_getColorG = *tinkercellc::tc_getColorG;
*tc_getColorB = *tinkercellc::tc_getColorB;
...
*tc_getConnectedNodesIn = *tinkercellc::tc_getConnectedNodesIn;
*tc_getConnectedNodesOut = *tinkercellc::tc_getConnectedNodesOut;
*tc_getConnectedNodesOther = *tinkercellc::tc_getConnectedNodesOther;
*tc_getConnections = *tinkercellc::tc_getConnections;
*tc_getConnectionsIn = *tinkercellc::tc_getConnectionsIn;
*tc_getConnectionsOut = *tinkercellc::tc_getConnectionsOut;
*tc_getConnectionsOther = *tinkercellc::tc_getConnectionsOther;
...
*tc_getModelParameters = *tinkercellc::tc_getModelParameters;
...
############# Class : tinkercell::Matrix ##############

package tinkercell::Matrix;
use vars qw(@ISA %OWNER %ITERATORS %BLESSEDMEMBERS);
@ISA = qw( tinkercell );
%OWNER = ();
%ITERATORS = ();
*swig_rows_get = *tinkercellc::Matrix_rows_get;
*swig_rows_set = *tinkercellc::Matrix_rows_set;
*swig_cols_get = *tinkercellc::Matrix_cols_get;
*swig_cols_set = *tinkercellc::Matrix_cols_set;
*swig_values_get = *tinkercellc::Matrix_values_get;
*swig_values_set = *tinkercellc::Matrix_values_set;
*swig_rownames_get = *tinkercellc::Matrix_rownames_get;
*swig_rownames_set = *tinkercellc::Matrix_rownames_set;
*swig_colnames_get = *tinkercellc::Matrix_colnames_get;
*swig_colnames_set = *tinkercellc::Matrix_colnames_set;
sub new {
    my $pkg = shift;
    my $self = tinkercellc::new_Matrix(@_);
    bless $self, $pkg if defined($self);
}
...
sub DESTROY {
    ...
    delete $ITERATORS{$self};
    if (exists $OWNER{$self}) {
        tinkercellc::delete_Matrix($self);
        delete $OWNER{$self};
    }
}
