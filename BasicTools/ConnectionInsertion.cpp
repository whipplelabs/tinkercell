...
namespace Tinkercell
{
     ...
     void ConnectionInsertion::pluginLoaded(const QString&)
     {
          connectToConnectionsTree();
     }
...
//           if (mainWindow->tools.contains(tr("Connections Tree")))
//           {
//                QWidget * treeWidget = mainWindow->tools.value(tr("Connections Tree"));
