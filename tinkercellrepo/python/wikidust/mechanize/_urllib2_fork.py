...
class HTTPRedirectHandler(BaseHandler):
    ...
    #TODO find the optimum values for these
    max_repeats = 100 # changed by Jeff to get registry sites working
    # maximum total number of redirections (regardless of URL) before
    # assuming we're in a loop
    max_redirections = 100 # changed by Jeff to get registry sites working
