...
static octave_value_list _wrap_tc_Main_api_initialize (const octave_value_list& args, int nargout) {
  ...
  if (!SWIG_check_num_args("tc_Main_api_initialize",args.length(),89,89,0)) {
    SWIG_fail;
  }
  {
  ...
  {
    int res = SWIG_ConvertFunctionPtr(args(79), (void**)(&arg80), SWIGTYPE_p_f___void);
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in method '" "tc_Main_api_initialize" "', argument " "80"" of type '" "void (*)()""'"); 
    }
  }
  {
    int res = SWIG_ConvertFunctionPtr(args(80), (void**)(&arg81), SWIGTYPE_p_f_long_long_int__double);
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in method '" "tc_Main_api_initialize" "', argument " "81"" of type '" "double (*)(long,long,int)""'"); 
    }
  }
  {
    int res = SWIG_ConvertFunctionPtr(args(81), (void**)(&arg82), SWIGTYPE_p_f_long_long_int__double);
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in method '" "tc_Main_api_initialize" "', argument " "82"" of type '" "double (*)(long,long,int)""'"); 
    }
  }
  {
    int res = SWIG_ConvertFunctionPtr(args(82), (void**)(&arg83), SWIGTYPE_p_f_long_long_int_double_double__void);
    if (!SWIG_IsOK(res)) {
...
static octave_value_list _wrap_tc_COPASI_api (const octave_value_list& args, int nargout) {
  ...
  if (!SWIG_check_num_args("tc_COPASI_api",args.length(),21,21,0)) {
    SWIG_fail;
  }
  {
