...
static octave_value_list _wrap_removeCopasiModel (const octave_value_list& args, int nargout) {
  copasi_model arg1 ;
  void *argp1 ;
  int res1 = 0 ;
  octave_value_list _out;
  ...
  if (!SWIG_check_num_args("removeCopasiModel",args.length(),1,1,0)) {
    SWIG_fail;
  }
  {
    res1 = SWIG_ConvertPtr(args(0), &argp1, SWIGTYPE_p_copasi_model,  0 );
...
static octave_value_list _wrap_clearCopasiModel (const octave_value_list& args, int nargout) {
  copasi_model arg1 ;
  void *argp1 ;
  int res1 = 0 ;
  octave_value_list _out;
  ...
  if (!SWIG_check_num_args("clearCopasiModel",args.length(),1,1,0)) {
    SWIG_fail;
  }
  {
    res1 = SWIG_ConvertPtr(args(0), &argp1, SWIGTYPE_p_copasi_model,  0 );
...
{"removeCopasiModel",_wrap_removeCopasiModel,0,0,2,0},
{"clearCopasiModel",_wrap_clearCopasiModel,0,0,2,0},
