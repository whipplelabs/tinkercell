...
namespace Tinkercell
{
	...
	public:
		...
		void createSliders(int, Matrix, MatrixInputFunction);
		...
		ArrayOfStrings getNumericalDataNames(int);
		ArrayOfStrings getTextDataNames(int);

		Matrix getNumericalData(int,const char*);
		void setNumericalData(int,const char*, Matrix);
		
		TableOfStrings getTextData(int,const char*);
		void setTextData(int,const char*,TableOfStrings);

		ArrayOfItems getChildren(int);
		int getParent(int);
	...
	*/
	...
	private:
		...
		static int _find(const char*);
		static ArrayOfItems _findItems(ArrayOfStrings);
		static void _select(int);
		static void _deselect();
		static const char* _getName(int);
		static const char* _getUniqueName(int);
		static void _setName(int,const char*);
		static ArrayOfStrings _getNames(ArrayOfItems);
		static ArrayOfStrings _getUniqueNames(ArrayOfItems);
		static const char* _getFamily(int);
		static int _isA(int,const char*);
		static void _removeItem(int);
		static void _setPos(int,double ,double );
		static void _setPos2(ArrayOfItems,Matrix);
		static Matrix _getPos(ArrayOfItems);
		static double _getY(int);
		static double _getX(int);
		...
		static void _createSliders(int, Matrix, MatrixInputFunction);
		...
		static ArrayOfStrings _getNumericalDataNames(int);
		static ArrayOfStrings _getTextDataNames(int);
		static Matrix _getNumericalData(int,const char*);
		static void _setNumericalData(int, const char *, Matrix);
		static TableOfStrings _getTextData(int,const char*);
		static void _setTextData(int, const char *, TableOfStrings);
		static ArrayOfItems _getChildren(int);
		static int _getParent(int);
		...
		static void _setSize(int,double,double,int);
		static double _getWidth(int);
		static double _getHeight(int);
		static void _setAngle(int,double,int);
		static double _getAngle(int);
		static const char* _getColor(int);
		static void _setColor(int,const char *,int);
		static void _changeGraphics(int,const char*);
		static void _changeArrowHead(int,const char*);
