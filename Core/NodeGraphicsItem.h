...
namespace Tinkercell
{
	...
	public:
		...
		*/
		MY_EXPORT static NodeGraphicsItem* cast(QGraphicsItem * q);
		...
		*/
		MY_EXPORT static NodeGraphicsItem * topLevelNodeItem(QGraphicsItem* item, bool ignoreControlPoints = false);
		...
		MY_EXPORT static const int numShapeTypes = 3;
