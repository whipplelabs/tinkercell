...
def tc_getFromList(*args):
  return _tinkercell.tc_getFromList(*args)
...
def tc_getModelParameters(*args):
  return _tinkercell.tc_getModelParameters(*args)
