...
class copasi_model(_object):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["CopasiModelPtr"] = _tinkercell.copasi_model_CopasiModelPtr_set
    __swig_getmethods__["CopasiModelPtr"] = _tinkercell.copasi_model_CopasiModelPtr_get
    if _newclass:CopasiModelPtr = _swig_property(_tinkercell.copasi_model_CopasiModelPtr_get, _tinkercell.copasi_model_CopasiModelPtr_set)
    __swig_setmethods__["CopasiDataModelPtr"] = _tinkercell.copasi_model_CopasiDataModelPtr_set
    __swig_getmethods__["CopasiDataModelPtr"] = _tinkercell.copasi_model_CopasiDataModelPtr_get
    if _newclass:CopasiDataModelPtr = _swig_property(_tinkercell.copasi_model_CopasiDataModelPtr_get, _tinkercell.copasi_model_CopasiDataModelPtr_set)
    __swig_setmethods__["qHash"] = _tinkercell.copasi_model_qHash_set
    __swig_getmethods__["qHash"] = _tinkercell.copasi_model_qHash_get
    if _newclass:qHash = _swig_property(_tinkercell.copasi_model_qHash_get, _tinkercell.copasi_model_qHash_set)
    def __init__(self): 
        this = _tinkercell.new_copasi_model()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _tinkercell.delete_copasi_model
    __del__ = lambda self : None;
copasi_model_swigregister = _tinkercell.copasi_model_swigregister
...
class copasi_reaction(_object):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["CopasiReactionPtr"] = _tinkercell.copasi_reaction_CopasiReactionPtr_set
    __swig_getmethods__["CopasiReactionPtr"] = _tinkercell.copasi_reaction_CopasiReactionPtr_get
    if _newclass:CopasiReactionPtr = _swig_property(_tinkercell.copasi_reaction_CopasiReactionPtr_get, _tinkercell.copasi_reaction_CopasiReactionPtr_set)
    __swig_setmethods__["CopasiModelPtr"] = _tinkercell.copasi_reaction_CopasiModelPtr_set
    __swig_getmethods__["CopasiModelPtr"] = _tinkercell.copasi_reaction_CopasiModelPtr_get
    if _newclass:CopasiModelPtr = _swig_property(_tinkercell.copasi_reaction_CopasiModelPtr_get, _tinkercell.copasi_reaction_CopasiModelPtr_set)
    __swig_setmethods__["qHash"] = _tinkercell.copasi_reaction_qHash_set
    __swig_getmethods__["qHash"] = _tinkercell.copasi_reaction_qHash_get
    if _newclass:qHash = _swig_property(_tinkercell.copasi_reaction_qHash_get, _tinkercell.copasi_reaction_qHash_set)
    def __init__(self): 
        this = _tinkercell.new_copasi_reaction()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _tinkercell.delete_copasi_reaction
    __del__ = lambda self : None;
copasi_reaction_swigregister = _tinkercell.copasi_reaction_swigregister
...
class copasi_compartment(_object):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["CopasiCompartmentPtr"] = _tinkercell.copasi_compartment_CopasiCompartmentPtr_set
    __swig_getmethods__["CopasiCompartmentPtr"] = _tinkercell.copasi_compartment_CopasiCompartmentPtr_get
    if _newclass:CopasiCompartmentPtr = _swig_property(_tinkercell.copasi_compartment_CopasiCompartmentPtr_get, _tinkercell.copasi_compartment_CopasiCompartmentPtr_set)
    __swig_setmethods__["CopasiModelPtr"] = _tinkercell.copasi_compartment_CopasiModelPtr_set
    __swig_getmethods__["CopasiModelPtr"] = _tinkercell.copasi_compartment_CopasiModelPtr_get
    if _newclass:CopasiModelPtr = _swig_property(_tinkercell.copasi_compartment_CopasiModelPtr_get, _tinkercell.copasi_compartment_CopasiModelPtr_set)
    __swig_setmethods__["qHash"] = _tinkercell.copasi_compartment_qHash_set
    __swig_getmethods__["qHash"] = _tinkercell.copasi_compartment_qHash_get
    if _newclass:qHash = _swig_property(_tinkercell.copasi_compartment_qHash_get, _tinkercell.copasi_compartment_qHash_set)
    def __init__(self): 
        this = _tinkercell.new_copasi_compartment()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _tinkercell.delete_copasi_compartment
    __del__ = lambda self : None;
copasi_compartment_swigregister = _tinkercell.copasi_compartment_swigregister
copasi_compartment_swigregister(copasi_compartment)


def copasi_init():
  return _tinkercell.copasi_init()
copasi_init = _tinkercell.copasi_init
...
loadModelFile = _tinkercell.loadModelFile

def createCompartment(*args):
  return _tinkercell.createCompartment(*args)
createCompartment = _tinkercell.createCompartment

def setVolume(*args):
  return _tinkercell.setVolume(*args)
setVolume = _tinkercell.setVolume
...
def createSpecies(*args):
  return _tinkercell.createSpecies(*args)
createSpecies = _tinkercell.createSpecies

def setBoundarySpecies(*args):
  return _tinkercell.setBoundarySpecies(*args)
setBoundarySpecies = _tinkercell.setBoundarySpecies

def setConcentration(*args):
  return _tinkercell.setConcentration(*args)
setConcentration = _tinkercell.setConcentration

def setAssignmentRule(*args):
  return _tinkercell.setAssignmentRule(*args)
setAssignmentRule = _tinkercell.setAssignmentRule

def setGlobalParameter(*args):
  return _tinkercell.setGlobalParameter(*args)
setGlobalParameter = _tinkercell.setGlobalParameter

def createVariable(*args):
  return _tinkercell.createVariable(*args)
createVariable = _tinkercell.createVariable

def createEvent(*args):
  return _tinkercell.createEvent(*args)
createEvent = _tinkercell.createEvent

def createReaction(*args):
  return _tinkercell.createReaction(*args)
createReaction = _tinkercell.createReaction

def addReactant(*args):
  return _tinkercell.addReactant(*args)
addReactant = _tinkercell.addReactant

def addProduct(*args):
  return _tinkercell.addProduct(*args)
addProduct = _tinkercell.addProduct

def setReactionRate(*args):
...
def simulateStochastic(*args):
  return _tinkercell.simulateStochastic(*args)
simulateStochastic = _tinkercell.simulateStochastic

def simulateHybrid(*args):
  return _tinkercell.simulateHybrid(*args)
simulateHybrid = _tinkercell.simulateHybrid

def simulateTauLeap(*args):
  return _tinkercell.simulateTauLeap(*args)
simulateTauLeap = _tinkercell.simulateTauLeap

def getSteadyState(*args):
  return _tinkercell.getSteadyState(*args)
getSteadyState = _tinkercell.getSteadyState

def getJacobian(*args):
  return _tinkercell.getJacobian(*args)
getJacobian = _tinkercell.getJacobian

def getEigenvalues(*args):
  return _tinkercell.getEigenvalues(*args)
getEigenvalues = _tinkercell.getEigenvalues

def getUnscaledElasticities(*args):
  return _tinkercell.getUnscaledElasticities(*args)
getUnscaledElasticities = _tinkercell.getUnscaledElasticities

def getUnscaledConcentrationCC(*args):
  return _tinkercell.getUnscaledConcentrationCC(*args)
getUnscaledConcentrationCC = _tinkercell.getUnscaledConcentrationCC

def getUnscaledFluxCC(*args):
  return _tinkercell.getUnscaledFluxCC(*args)
getUnscaledFluxCC = _tinkercell.getUnscaledFluxCC

def getScaledElasticities(*args):
  return _tinkercell.getScaledElasticities(*args)
getScaledElasticities = _tinkercell.getScaledElasticities

def getScaledConcentrationCC(*args):
  return _tinkercell.getScaledConcentrationCC(*args)
getScaledConcentrationCC = _tinkercell.getScaledConcentrationCC
