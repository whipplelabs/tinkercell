...
name: Maximize a formula (steady state)
description: Maximize the given formula. Values are computed at steady state
icon: up.png
menu: yes
tool: no
"""
...
minimize = False
res = CrossEntropy.OptimizeParameters(FitFormula_Objective, "Maximize " + optimFormula, 100, 100, minimize)
mu = res[0]
sigma2 = res[1]
paramnames = res[2]
