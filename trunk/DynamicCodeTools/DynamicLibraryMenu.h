...
namespace Tinkercell
{
	...
	*/
	class MY_EXPORT DynamicLibraryMenu_FToS : public QObject
	{
		...
		signals:
			...
			/*! \brief Part of the TinkerCell C interface. */
			void getSelectedString(QSemaphore*,int*,const QString&,const QStringList&,int);
			/*! \brief Part of the TinkerCell C interface. */
	...
	*/
	...
	protected slots:
		void itemsInserted(GraphicsScene* scene, const QList<QGraphicsItem *>& , const QList<ItemHandle*>& handles);
	...
	private:
		...
		/*! \brief Part of the TinkerCell C interface. */
		static int _getSelectedString(const char*, char**,int);
		/*! \brief Part of the TinkerCell C interface. */
...
// 		class GraphicalActionTool : public GraphicalTool
// 		{
// 		public:
// 			/*! \brief constructor
// 				\param QPixmap icon for the tool
// 			*/
// 			GraphicalActionTool(const QString& name, const QPixmap& pixmap);
