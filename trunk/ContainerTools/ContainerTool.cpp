...
namespace Tinkercell
{
	ContainerTreeTool::ContainerTreeTool() : Tool(tr("Attributes View"))
	{
		...
		treeDelegate = new ContainerTreeDelegate(this);
	...
	bool ContainerTreeTool::setMainWindow(MainWindow * main)
	{
		...
		if (mainWindow)
		{
			...
			//treeView->setColumnWidth(1,40);
			treeView->setColumnWidth(2,50);
			mainWindow->addDockingWindow(name,treeView,Qt::RightDockWidgetArea);
	...
	void ContainerTreeTool::pluginLoaded(const QString&)
	{
		connectCollisionDetector();
	}
...
// 		}
	...
	******************************/
	...
	ContainerTreeDelegate::ContainerTreeDelegate(QObject *parent)
