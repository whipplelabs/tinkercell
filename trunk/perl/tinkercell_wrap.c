...
XS(_wrap_tc_Main_api_initialize) {
  {
    ...
    {
      int res = SWIG_ConvertFunctionPtr(ST(60), (void**)(&arg61), SWIGTYPE_p_f_long__p_char);
      if (!SWIG_IsOK(res)) {
        SWIG_exception_fail(SWIG_ArgError(res), "in method '" "tc_Main_api_initialize" "', argument " "61"" of type '" "char const *(*)(long)""'"); 
      }
    }
    {
      int res = SWIG_ConvertFunctionPtr(ST(61), (void**)(&arg62), SWIGTYPE_p_f_long_p_q_const__char_int__void);
      if (!SWIG_IsOK(res)) {
    ...
    {
      int res = SWIG_ConvertFunctionPtr(ST(64), (void**)(&arg65), SWIGTYPE_p_f_p_q_const__char_int_int__void);
      if (!SWIG_IsOK(res)) {
    ...
    {
      int res = SWIG_ConvertFunctionPtr(ST(77), (void**)(&arg78), SWIGTYPE_p_f___void);
      if (!SWIG_IsOK(res)) {
...
XS(_wrap_tc_setParameters) {
  {
    ...
    if ((items < 2) || (items > 2)) {
      SWIG_croak("Usage: tc_setParameters(tc_matrix,int);");
    }
    {
      res1 = SWIG_ConvertPtr(ST(0), &argp1, SWIGTYPE_p_tc_matrix,  0 );
      if (!SWIG_IsOK(res1)) {
