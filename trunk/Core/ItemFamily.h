...
namespace Tinkercell
{
	...
	*/
	...
	public:
		...
		virtual QList<ItemFamily*> subFamilies() const { return QList<ItemFamily*>(); }
		/*! \brief destructor.*/
          virtual ~ItemFamily();
          /*! \brief constructor.*/
          ItemFamily();
	...
	*/
	...
	public:
		...
		/*! \brief all the families that make up this family*/
		QList<NodeFamily*> includedFamilies;
		/*! \brief indicates whether or not the given string is the name of this family or any of its parent families*/
		...
		/*! \brief get all the families that make up this family.*/
		virtual QList<ItemFamily*> subFamilies() const;
		/*! \brief destructor.*/
          virtual ~NodeFamily();
          /*! \brief constructor.*/
          NodeFamily();
	...
	*/
	...
	public:
		...
		/*! \brief all the families that make up this family*/
		QList<ConnectionFamily*> includedFamilies;
		/*! \brief indicates whether or not the given string is the name of this family or any of its parent families*/
		virtual bool isA(const QString& familyName) const;
		/*! \brief get the parent for this family. If there are more than one parents, returns the first*/
		virtual ItemFamily* parent() const;
