	...
	*/
	...
	public: 
		...
		* \return path vector with all the control points and nodes and arrows*/
		static ConnectionGraphicsItem::CurveSegment readCurveSegment(QHash<QString, QList<QGraphicsItem*> >& nodes, QHash<QString, QList<QGraphicsItem*> >& connections, QList<ConnectionGraphicsItem::ControlPoint*>& controlPoints, NodeGraphicsReader *, const QString& groupID=QString());
