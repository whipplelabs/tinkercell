...
Filename: {app}\\installation\\numpy-1.6.1-win32-superpack-python2.5.exe; Description: \"install Python Numeric package\"; WorkingDir: {app}; Flags: postinstall\n\
Filename: {app}\\installation\\scipy-0.9.0-win32-superpack-python2.5.exe; Description: \"install Python Scientific package\"; WorkingDir: {app}; Flags: postinstall\n\
