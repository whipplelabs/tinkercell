...
Filename: {app}\\installation\\scipy-0.9.0-win32-superpack-python2.6.exe; Description: \"install Scientific Python package\"; WorkingDir: {app}; Flags: postinstall unchecked\n\
