...
Filename: {app}\\installation\\numpy-1.6.1-win32-superpack-python2.6.exe; Description: \"install Python Numeric package\"; WorkingDir: {app}; Flags: postinstall checked\n\
Filename: {app}\\installation\\scipy-0.9.0-win32-superpack-python2.6.exe; Description: \"install Python Scientific package\"; WorkingDir: {app}; Flags: postinstall checked\n\
...
Filename: {app}\\installation\\pysces-0.7.8.win32-py2.6.exe; Description: \"install Python Cell Simulation package\"; WorkingDir: {app}; Flags: postinstall unchecked\n\
