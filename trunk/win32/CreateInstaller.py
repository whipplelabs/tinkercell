...
Filename: {app}\\installation\\numpy-1.3.0-win32-superpack-python2.5.exe; Description: \"NumPy (MUST run as administrator)\"; WorkingDir: {app}; Flags: postinstall unchecked\n\
Filename: {app}\\installation\\scipy-0.7.1-win32-superpack-python2.5.exe; Description: \"SciPy (MUST run as administrator)\"; WorkingDir: {app}; Flags: postinstall unchecked\n\
...
Filename: {app}\\@TINKERCELL_EXE@.exe; Description: \"run @TINKERCELL_EXE@\"; WorkingDir: {app}; Flags: postinstall unchecked\n\
[Icons]\n\
