...
public class Trigger extends SBase {
   ...
   * {@link Trigger}
   * <p>
   * @note Once a {@link Trigger} has been added to an {@link SBMLDocument}, the <code>level</code>,
   * <code>version</code> for the document <em>override</em> those used
   * to create the {@link Trigger}.  Despite this, the ability to supply the values
