 ...
 * <p>
 * The error log is simply a list.  Each {@link SBMLDocument} maintains its own
 ...
 * determining how many {@link SBMLError} or {@link XMLError} objects are in the log.
 ...
 * as {@link SBMLDocument}.  Callers should then use SBMLErrorLog.getNumErrors()
 * to inquire how many objects there are in the list.  (The answer may be
 * 0.)  If there is at least one {@link SBMLError} object in the {@link SBMLErrorLog}
 * instance, callers can then iterate over the list using 
 * {@link SBMLErrorLog#getError(long n)}, using
 * methods on {@link SBMLError}  to find out the error code and associated
...
public class SBMLErrorLog extends XMLErrorLog {
   ...
   {
     super(libsbmlJNI.SWIGSBMLErrorLogUpcast(cPtr), cMemoryOwn);
     swigCPtr = cPtr;
   }
  ...
  /**
   * Returns the nth {@link SBMLError} in this log.
   * <p>
   ...
   * inherited from the parent class, {@link XMLErrorLog}).  Attempting to using an
   ...
   * <p>
   * @return the <code>n</code>th {@link SBMLError} in this log.
   */
