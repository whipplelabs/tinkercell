...
REM Revision    : $Id: make.bat 8704 2009-01-04 02:26:05Z mhucka $
REM $HeadURL: https://sbml.svn.sourceforge.net/svnroot/sbml/trunk/libsbml/src/bindings/matlab/make.bat $
REM
...
REM
REM    Sarah Keating
REM    Science and Technology Research Centre
REM    University of Hertfordshire
