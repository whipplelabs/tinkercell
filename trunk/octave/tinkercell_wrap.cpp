...
static octave_value_list _wrap_tc_Main_api_initialize (const octave_value_list& args, int nargout) {
  ...
  if (!SWIG_check_num_args("tc_Main_api_initialize",args.length(),65,65,0)) {
    SWIG_fail;
  }
  {
  ...
  {
    int res = SWIG_ConvertFunctionPtr(args(62), (void**)(&arg63), SWIGTYPE_p_f_p_q_const__char_int_int__void);
    if (!SWIG_IsOK(res)) {
      SWIG_exception_fail(SWIG_ArgError(res), "in method '" "tc_Main_api_initialize" "', argument " "63"" of type '" "void (*)(char const *,int,int)""'"); 
    }
  }
  {
    int res = SWIG_ConvertFunctionPtr(args(63), (void**)(&arg64), SWIGTYPE_p_f___int);
    if (!SWIG_IsOK(res)) {
...
static octave_value_list _wrap_tc_steadyStateScan (const octave_value_list& args, int nargout) {
  ...
  if (!SWIG_check_num_args("tc_steadyStateScan",args.length(),3,3,0)) {
    SWIG_fail;
  }
  res1 = SWIG_AsCharPtrAndSize(args(0), &buf1, NULL, &alloc1);
  if (!SWIG_IsOK(res1)) {
...
static octave_value_list _wrap_tc_SBML_api (const octave_value_list& args, int nargout) {
  ...
  {
    int res = SWIG_ConvertFunctionPtr(args(4), (void**)(&arg5), SWIGTYPE_p_f_p_q_const__char_double_double__tc_matrix);
    if (!SWIG_IsOK(res)) {
