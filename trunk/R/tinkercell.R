...
attr(`tc_getColorR`, 'returnType') = 'integer'
...
attr(`tc_getColorG`, 'returnType') = 'integer'
...
attr(`tc_getColorB`, 'returnType') = 'integer'
...
attr(`tc_setColor`, "inputTypes") = c('_p_void', 'integer', 'integer', 'integer', 'integer')
