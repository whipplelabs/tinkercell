...
`tc_SBML_api` = function(exportSBML, importSBML, exportText, importText, exportMath, sbmlString, antimonyString)
{
  ...
  antimonyString = as(antimonyString, "character"); 
...
attr(`tc_SBML_api`, "inputTypes") = c('_p_f_p_q_const__char__void', '_p_f_p_q_const__char__void', '_p_f_p_q_const__char__void', '_p_f_p_q_const__char__void', '_p_f_p_q_const__char__void', '_p_f___p_char', 'character')
