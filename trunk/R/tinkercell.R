...
##
setClass('_p_f_tc_strings__tc_matrix',
        prototype = list(parameterTypes = c('_tc_strings'),
                        returnType = '_p_f_tc_strings__tc_matrix'),
        contains = 'CRoutinePointer')
...
##
setClass('_p_f_p_q_const__char__tc_table',
        prototype = list(parameterTypes = c('_p_char'),
                        returnType = '_p_f_p_q_const__char__tc_table'),
        contains = 'CRoutinePointer')
...
`tc_strings` = function()
{
  ...
  reg.finalizer(ans, delete_tc_strings)
  ans
...
`tc_items` = function()
{
  ...
  reg.finalizer(ans, delete_tc_items)
  ans
...
`tc_matrix` = function()
{
  ...
  reg.finalizer(ans, delete_tc_matrix)
  ans
...
`tc_table` = function()
{
  ...
  reg.finalizer(ans, delete_tc_table)
  ans
...
# Start of tc_findItemsUsingRegexp

`tc_findItemsUsingRegexp` = function(names, .copy = FALSE)
{
  names = as(names, "character"); 
  ;ans = .Call('R_swig_tc_findItemsUsingRegexp', names, as.logical(.copy), PACKAGE='tinkercell');
  class(ans) <- "_p_tc_items";
...
attr(`tc_findItemsUsingRegexp`, 'returnType') = '_p_tc_items'
attr(`tc_findItemsUsingRegexp`, "inputTypes") = c('character')
class(`tc_findItemsUsingRegexp`) = c("SWIGFunction", class('tc_findItemsUsingRegexp'))
...
# Start of tc_getNumericalValueUsingRegexp

`tc_getNumericalValueUsingRegexp` = function(regex, .copy = FALSE)
{
  regex = as(regex, "character"); 
  ;ans = .Call('R_swig_tc_getNumericalValueUsingRegexp', regex, as.logical(.copy), PACKAGE='tinkercell');
  class(ans) <- "_p_tc_matrix";
...
attr(`tc_getNumericalValueUsingRegexp`, 'returnType') = '_p_tc_matrix'
attr(`tc_getNumericalValueUsingRegexp`, "inputTypes") = c('character')
class(`tc_getNumericalValueUsingRegexp`) = c("SWIGFunction", class('tc_getNumericalValueUsingRegexp'))
...
# Start of tc_getTextValueUsingRegexp

`tc_getTextValueUsingRegexp` = function(regex, .copy = FALSE)
{
  regex = as(regex, "character"); 
  ;ans = .Call('R_swig_tc_getTextValueUsingRegexp', regex, as.logical(.copy), PACKAGE='tinkercell');
  class(ans) <- "_p_tc_table";
...
attr(`tc_getTextValueUsingRegexp`, 'returnType') = '_p_tc_table'
attr(`tc_getTextValueUsingRegexp`, "inputTypes") = c('character')
class(`tc_getTextValueUsingRegexp`) = c("SWIGFunction", class('tc_getTextValueUsingRegexp'))
...
# Start of tc_viewWindow

`tc_viewWindow` = function(name)
{
  name = as(name, "character"); 
  ;.Call('R_swig_tc_viewWindow', name, PACKAGE='tinkercell');
  
}

attr(`tc_viewWindow`, 'returnType') = 'void'
attr(`tc_viewWindow`, "inputTypes") = c('character')
class(`tc_viewWindow`) = c("SWIGFunction", class('tc_viewWindow'))
...
`tc_getNumbers` = function(labels, .copy = FALSE)
{
  ;ans = .Call('R_swig_tc_getNumbers', labels, as.logical(.copy), PACKAGE='tinkercell');
  class(ans) <- "_p_tc_matrix";
...
attr(`tc_getNumbers`, 'returnType') = '_p_tc_matrix'
attr(`tc_getNumbers`, "inputTypes") = c('_p_tc_strings')
...
# Start of tc_createSlidersForScript

`tc_createSlidersForScript` = function(input, s_arg2)
{
  s_arg2 = as(s_arg2, "character"); 
  ;.Call('R_swig_tc_createSlidersForScript', input, s_arg2, PACKAGE='tinkercell');
  
}

attr(`tc_createSlidersForScript`, 'returnType') = 'void'
attr(`tc_createSlidersForScript`, "inputTypes") = c('_p_tc_matrix', 'character')
class(`tc_createSlidersForScript`) = c("SWIGFunction", class('tc_createSlidersForScript'))
...
`tc_Main_api_initialize` = function(tc_allItems0, tc_selectedItems0, tc_itemsOfFamily0, tc_itemsOfFamily1, tc_find0, tc_findItems0, tc_findItemsUsingRegexp0, tc_select0, tc_deselect0, tc_getName0, tc_getUniqueName0, tc_setName0, tc_getNames0, tc_getUniqueNames0, tc_getFamily0, tc_isA0, tc_clearText, tc_outputText0, tc_errorReport0, tc_outputTable0, tc_printFile0, tc_removeItem0, insertItem, insertConnection, getConnectedParts, getConnections, tc_getY0, tc_getX0, tc_getPos0, tc_setPos0, tc_setPos1, tc_moveSelected0, tc_isWindows0, tc_isMac0, tc_isLinux0, tc_appDir0, tc_homeDir0, tc_createInputWindow0, tc_createInputWindow1, createSliders1, createSliders2, tc_addInputWindowOptions0, tc_addInputWindowCheckbox0, tc_openNewWindow0, tc_getChildren0, tc_getParent0, tc_getNumericalData0, tc_setNumericalData0, tc_getTextData0, tc_setTextData0, tc_getNumericalDataNames0, tc_getTextDataNames0, tc_zoom0, tc_viewWindow0, tc_getStringDialog0, getSelectedString, getNumber, getNumbers, getFilename, askQuestion, messageDialog, openFile, saveToFile, setSize0, getWidth0, getHeight0, setAngle0, getColor, setColor0, changeGraphics0, changeArrowHead0, screenshot, screenHeight, screenWidth, screenX, screenY, annotations, insertAnnotations, setNumericalValues, setNumericalValue, setTextValues, setTextValue, getNumericalValue, getTextValue, getNumericalValueUsingRegexp, getTextValueUsingRegexp, openUrl, getControlPointX, getControlPointY, setControlPoint, setCenterPoint, getCenterPointX, getCenterPointY, setStraight, setAllStraight, setLineWidth)
{
  ...
  if(is.function(tc_findItemsUsingRegexp0)) {
    assert('...' %in% names(formals(tc_findItemsUsingRegexp0)) || length(formals(tc_findItemsUsingRegexp0)) >= 0);
  } else {
    if(is.character(tc_findItemsUsingRegexp0)) {
      tc_findItemsUsingRegexp0 = getNativeSymbolInfo(tc_findItemsUsingRegexp0);
    };
    if(is(tc_findItemsUsingRegexp0, "NativeSymbolInfo")) {
      tc_findItemsUsingRegexp0 = tc_findItemsUsingRegexp0$address;
    }
  }; 
  ...
  if(is.function(getConnectedParts)) {
    assert('...' %in% names(formals(getConnectedParts)) || length(formals(getConnectedParts)) >= 1);
  } else {
  ...
  if(is.function(createSliders1)) {
    assert('...' %in% names(formals(createSliders1)) || length(formals(createSliders1)) >= 3);
  } else {
    if(is.character(createSliders1)) {
      createSliders1 = getNativeSymbolInfo(createSliders1);
    };
    if(is(createSliders1, "NativeSymbolInfo")) {
      createSliders1 = createSliders1$address;
    }
  }; 
  if(is.function(createSliders2)) {
    assert('...' %in% names(formals(createSliders2)) || length(formals(createSliders2)) >= 2);
  } else {
    if(is.character(createSliders2)) {
      createSliders2 = getNativeSymbolInfo(createSliders2);
    };
    if(is(createSliders2, "NativeSymbolInfo")) {
      createSliders2 = createSliders2$address;
    }
  }; 
  ...
  if(is.function(tc_getChildren0)) {
    assert('...' %in% names(formals(tc_getChildren0)) || length(formals(tc_getChildren0)) >= 0);
  } else {
  ...
  if(is.function(tc_viewWindow0)) {
    assert('...' %in% names(formals(tc_viewWindow0)) || length(formals(tc_viewWindow0)) >= 0);
  } else {
    if(is.character(tc_viewWindow0)) {
      tc_viewWindow0 = getNativeSymbolInfo(tc_viewWindow0);
    };
    if(is(tc_viewWindow0, "NativeSymbolInfo")) {
      tc_viewWindow0 = tc_viewWindow0$address;
    }
  }; 
  ...
  if(is.function(getNumbers)) {
    assert('...' %in% names(formals(getNumbers)) || length(formals(getNumbers)) >= 1);
  } else {
  ...
  if(is.function(getNumericalValueUsingRegexp)) {
    assert('...' %in% names(formals(getNumericalValueUsingRegexp)) || length(formals(getNumericalValueUsingRegexp)) >= 1);
  } else {
    if(is.character(getNumericalValueUsingRegexp)) {
      getNumericalValueUsingRegexp = getNativeSymbolInfo(getNumericalValueUsingRegexp);
    };
    if(is(getNumericalValueUsingRegexp, "NativeSymbolInfo")) {
      getNumericalValueUsingRegexp = getNumericalValueUsingRegexp$address;
    }
  }; 
  if(is.function(getTextValueUsingRegexp)) {
    assert('...' %in% names(formals(getTextValueUsingRegexp)) || length(formals(getTextValueUsingRegexp)) >= 1);
  } else {
    if(is.character(getTextValueUsingRegexp)) {
      getTextValueUsingRegexp = getNativeSymbolInfo(getTextValueUsingRegexp);
    };
    if(is(getTextValueUsingRegexp, "NativeSymbolInfo")) {
      getTextValueUsingRegexp = getTextValueUsingRegexp$address;
    }
  }; 
  ...
  ;.Call('R_swig_tc_Main_api_initialize', tc_allItems0, tc_selectedItems0, tc_itemsOfFamily0, tc_itemsOfFamily1, tc_find0, tc_findItems0, tc_findItemsUsingRegexp0, tc_select0, tc_deselect0, tc_getName0, tc_getUniqueName0, tc_setName0, tc_getNames0, tc_getUniqueNames0, tc_getFamily0, tc_isA0, tc_clearText, tc_outputText0, tc_errorReport0, tc_outputTable0, tc_printFile0, tc_removeItem0, insertItem, insertConnection, getConnectedParts, getConnections, tc_getY0, tc_getX0, tc_getPos0, tc_setPos0, tc_setPos1, tc_moveSelected0, tc_isWindows0, tc_isMac0, tc_isLinux0, tc_appDir0, tc_homeDir0, tc_createInputWindow0, tc_createInputWindow1, createSliders1, createSliders2, tc_addInputWindowOptions0, tc_addInputWindowCheckbox0, tc_openNewWindow0, tc_getChildren0, tc_getParent0, tc_getNumericalData0, tc_setNumericalData0, tc_getTextData0, tc_setTextData0, tc_getNumericalDataNames0, tc_getTextDataNames0, tc_zoom0, tc_viewWindow0, tc_getStringDialog0, getSelectedString, getNumber, getNumbers, getFilename, askQuestion, messageDialog, openFile, saveToFile, setSize0, getWidth0, getHeight0, setAngle0, getColor, setColor0, changeGraphics0, changeArrowHead0, screenshot, screenHeight, screenWidth, screenX, screenY, annotations, insertAnnotations, setNumericalValues, setNumericalValue, setTextValues, setTextValue, getNumericalValue, getTextValue, getNumericalValueUsingRegexp, getTextValueUsingRegexp, openUrl, getControlPointX, getControlPointY, setControlPoint, setCenterPoint, getCenterPointX, getCenterPointY, setStraight, setAllStraight, setLineWidth, PACKAGE='tinkercell');
  
}

attr(`tc_Main_api_initialize`, 'returnType') = 'void'
attr(`tc_Main_api_initialize`, "inputTypes") = c('_p_f___tc_items', '_p_f___tc_items', '_p_f_p_q_const__char__tc_items', '_p_f_p_q_const__char_tc_items__tc_items', '_p_f_p_q_const__char__long', '_p_f_tc_strings__tc_items', '_p_f_p_q_const__char__tc_items', '_p_f_long__void', '_p_f___void', '_p_f_long__p_char', '_p_f_long__p_char', '_p_f_long_p_q_const__char__void', '_p_f_tc_items__tc_strings', '_p_f_tc_items__tc_strings', '_p_f_long__p_char', '_p_f_long_p_q_const__char__int', '_p_f___void', '_p_f_p_q_const__char__void', '_p_f_p_q_const__char__void', '_p_f_tc_matrix__void', '_p_f_p_q_const__char__void', '_p_f_long__void', '_p_f_p_q_const__char_p_q_const__char__long', '_p_f_tc_items_p_q_const__char_p_q_const__char__long', '_p_f_long__tc_items', '_p_f_long__tc_items', '_p_f_long__double', '_p_f_long__double', '_p_f_tc_items__tc_matrix', '_p_f_long_double_double__void', '_p_f_tc_items_tc_matrix__void', '_p_f_double_double__void', '_p_f___int', '_p_f___int', '_p_f___int', '_p_f___p_char', '_p_f___p_char', '_p_f_tc_matrix_p_q_const__char_p_q_const__char__void', '_p_f_long_tc_matrix_p_q_const__char_p_f_tc_matrix__void__void', '_p_f_long_tc_matrix_p_f_tc_matrix__void__void', '_p_f_tc_matrix_p_q_const__char__void', '_p_f_p_q_const__char_int_int_tc_strings__void', '_p_f_p_q_const__char_int_int__void', '_p_f_p_q_const__char__void', '_p_f_long__tc_items', '_p_f_long__long', '_p_f_long_p_q_const__char__tc_matrix', '_p_f_long_p_q_const__char_tc_matrix__void', '_p_f_long_p_q_const__char__tc_table', '_p_f_long_p_q_const__char_tc_table__void', '_p_f_long__tc_strings', '_p_f_long__tc_strings', '_p_f_double__void', '_p_f_p_q_const__char__void', '_p_f_p_q_const__char__p_char', '_p_f_p_q_const__char_tc_strings_p_q_const__char__int', '_p_f_p_q_const__char__double', '_p_f_tc_strings__tc_matrix', '_p_f___p_char', '_p_f_p_q_const__char__int', '_p_f_p_q_const__char__void', '_p_f_p_q_const__char__void', '_p_f_p_q_const__char__void', '_p_f_long_double_double_int__void', '_p_f_long__double', '_p_f_long__double', '_p_f_long_double_int__void', '_p_f_long__p_char', '_p_f_long_p_q_const__char_int__void', '_p_f_long_p_q_const__char__void', '_p_f_long_p_q_const__char__void', '_p_f_p_q_const__char_int_int__void', '_p_f___int', '_p_f___int', '_p_f___int', '_p_f___int', '_p_f___p_char', '_p_f_p_q_const__char_double_double__void', '_p_f_tc_matrix__void', '_p_f_p_q_const__char_double__void', '_p_f_tc_table__void', '_p_f_p_q_const__char_p_q_const__char__void', '_p_f_p_q_const__char__double', '_p_f_p_q_const__char__p_char', '_p_f_p_q_const__char__tc_matrix', '_p_f_p_q_const__char__tc_table', '_p_f___void', '_p_f_long_long_int__double', '_p_f_long_long_int__double', '_p_f_long_long_int_double_double__void', '_p_f_long_double_double__void', '_p_f_long__double', '_p_f_long__double', '_p_f_long_int__void', '_p_f_int__void', '_p_f_long_double_int__void')
...
{
  ;.Call('R_swig_ApplySpringForce', nodes, connections, spring, charge, damping, as.logical(.copy), PACKAGE='tinkercell');
  
}

attr(`ApplySpringForce`, 'returnType') = 'numeric'
attr(`ApplySpringForce`, "inputTypes") = c('_p_tc_matrix', '_p_tc_matrix', 'numeric', 'numeric', 'numeric')
class(`ApplySpringForce`) = c("SWIGFunction", class('ApplySpringForce'))
...
`tc_setParameters` = function(parameters, permanentOrTemporary)
{
  permanentOrTemporary = as.integer(permanentOrTemporary); 
  
  if(length(permanentOrTemporary) > 1) {
    warning("using only the first element of permanentOrTemporary");
  };
  
  ;.Call('R_swig_tc_setParameters', parameters, permanentOrTemporary, PACKAGE='tinkercell');
...
`tc_ConnectionInsertion_api` = function(getConnectedPartsWithRole, getConnectionsWithRole)
{
  ...
  ;.Call('R_swig_tc_ConnectionInsertion_api', getConnectedPartsWithRole, getConnectionsWithRole, PACKAGE='tinkercell');
  
}

attr(`tc_ConnectionInsertion_api`, 'returnType') = 'void'
attr(`tc_ConnectionInsertion_api`, "inputTypes") = c('_p_f_long_p_q_const__char__tc_items', '_p_f_long_p_q_const__char__tc_items')
...
# Start of tc_displayCode

`tc_displayCode` = function(code)
{
  code = as(code, "character"); 
  ;.Call('R_swig_tc_displayCode', code, PACKAGE='tinkercell');
  
}

attr(`tc_displayCode`, 'returnType') = 'void'
attr(`tc_displayCode`, "inputTypes") = c('character')
class(`tc_displayCode`) = c("SWIGFunction", class('tc_displayCode'))
...
`tc_LoadCLibraries_api` = function(compileAndRun, compileBuildLoad, compileBuildLoadSliders, loadLibrary, addFunction, displayCode)
{
  ...
  if(is.function(displayCode)) {
    assert('...' %in% names(formals(displayCode)) || length(formals(displayCode)) >= 0);
  } else {
    if(is.character(displayCode)) {
      displayCode = getNativeSymbolInfo(displayCode);
    };
    if(is(displayCode, "NativeSymbolInfo")) {
      displayCode = displayCode$address;
    }
  }; 
  ;.Call('R_swig_tc_LoadCLibraries_api', compileAndRun, compileBuildLoad, compileBuildLoadSliders, loadLibrary, addFunction, displayCode, PACKAGE='tinkercell');
...
# Start of tc_closePlots

`tc_closePlots` = function()
{
  ;.Call('R_swig_tc_closePlots', PACKAGE='tinkercell');
  
}

attr(`tc_closePlots`, 'returnType') = 'void'
class(`tc_closePlots`) = c("SWIGFunction", class('tc_closePlots'))
...
`tc_clusterPlots` = function(clusters, .copy = FALSE)
{
  ...
  ;ans = .Call('R_swig_tc_clusterPlots', clusters, as.logical(.copy), PACKAGE='tinkercell');
  class(ans) <- "_p_tc_matrix";
...
attr(`tc_clusterPlots`, 'returnType') = '_p_tc_matrix'
...
{
  if(is.function(plot)) {
    assert('...' %in% names(formals(plot)) || length(formals(plot)) >= 0);
  } else {
  ...
  if(is.function(enableClustering)) {
    assert('...' %in% names(formals(enableClustering)) || length(formals(enableClustering)) >= 1);
  } else {
  ...
  if(is.function(plotData)) {
    assert('...' %in% names(formals(plotData)) || length(formals(plotData)) >= 0);
  } else {
...
attr(`tc_PlotTool_api`, "inputTypes") = c('_p_f_tc_matrix_p_q_const__char__void', '_p_f_tc_matrix_p_q_const__char__void', '_p_f_tc_matrix_p_q_const__char__void', '_p_f_tc_matrix_p_q_const__char__void', '_p_f_tc_matrix_p_q_const__char__void', '_p_f_int_int__void', '_p_f_int__void', '_p_f_int__tc_matrix', '_p_f_int__tc_matrix', '_p_f_p_q_const__char__void', '_p_f_p_q_const__char__void', '_p_f_int__void')
...
`tc_getSBMLString` = function()
{
  ;.Call('R_swig_tc_getSBMLString', PACKAGE='tinkercell');
...
`tc_getAntimonyString` = function()
{
  ;.Call('R_swig_tc_getAntimonyString', PACKAGE='tinkercell');
...
# Start of tc_exportAntimony

`tc_exportAntimony` = function(file)
{
  file = as(file, "character"); 
  ;.Call('R_swig_tc_exportAntimony', file, PACKAGE='tinkercell');
  
}

attr(`tc_exportAntimony`, 'returnType') = 'void'
attr(`tc_exportAntimony`, "inputTypes") = c('character')
class(`tc_exportAntimony`) = c("SWIGFunction", class('tc_exportAntimony'))

# Start of tc_importAntimony

`tc_importAntimony` = function(file)
{
  file = as(file, "character"); 
  ;.Call('R_swig_tc_importAntimony', file, PACKAGE='tinkercell');
  
}

attr(`tc_importAntimony`, 'returnType') = 'void'
attr(`tc_importAntimony`, "inputTypes") = c('character')
class(`tc_importAntimony`) = c("SWIGFunction", class('tc_importAntimony'))
...
`tc_SBML_api` = function(exportSBML, importSBML, exportText, importText, exportMath, sbmlString, antimonyString)
{
  ...
  if(is.function(sbmlString)) {
    assert('...' %in% names(formals(sbmlString)) || length(formals(sbmlString)) >= 0);
  } else {
    if(is.character(sbmlString)) {
      sbmlString = getNativeSymbolInfo(sbmlString);
    };
    if(is(sbmlString, "NativeSymbolInfo")) {
      sbmlString = sbmlString$address;
    }
  }; 
  if(is.function(antimonyString)) {
    assert('...' %in% names(formals(antimonyString)) || length(formals(antimonyString)) >= 0);
  } else {
    if(is.character(antimonyString)) {
      antimonyString = getNativeSymbolInfo(antimonyString);
    };
    if(is(antimonyString, "NativeSymbolInfo")) {
      antimonyString = antimonyString$address;
    }
  }; 
  ;.Call('R_swig_tc_SBML_api', exportSBML, importSBML, exportText, importText, exportMath, sbmlString, antimonyString, PACKAGE='tinkercell');
  
}

attr(`tc_SBML_api`, 'returnType') = 'void'
attr(`tc_SBML_api`, "inputTypes") = c('_p_f_p_q_const__char__void', '_p_f_p_q_const__char__void', '_p_f_p_q_const__char__void', '_p_f_p_q_const__char__void', '_p_f_p_q_const__char__void', '_p_f___p_char', '_p_f___p_char')
...
# Start of tc_calcFluxes

`tc_calcFluxes` = function(.copy = FALSE)
{
  ;ans = .Call('R_swig_tc_calcFluxes', as.logical(.copy), PACKAGE='tinkercell');
  class(ans) <- "_p_tc_matrix";
...
attr(`tc_calcFluxes`, 'returnType') = '_p_tc_matrix'
class(`tc_calcFluxes`) = c("SWIGFunction", class('tc_calcFluxes'))

# Start of tc_calcDerivatives

`tc_calcDerivatives` = function(.copy = FALSE)
{
  ;ans = .Call('R_swig_tc_calcDerivatives', as.logical(.copy), PACKAGE='tinkercell');
  class(ans) <- "_p_tc_matrix";
...
attr(`tc_calcDerivatives`, 'returnType') = '_p_tc_matrix'
class(`tc_calcDerivatives`) = c("SWIGFunction", class('tc_calcDerivatives'))
...
# Start of tc_enableAssignmentRulesReordering

`tc_enableAssignmentRulesReordering` = function(s_arg1)
{
  s_arg1 = as.integer(s_arg1); 
  ...
  ;.Call('R_swig_tc_enableAssignmentRulesReordering', s_arg1, PACKAGE='tinkercell');
  
}

attr(`tc_enableAssignmentRulesReordering`, 'returnType') = 'void'
attr(`tc_enableAssignmentRulesReordering`, "inputTypes") = c('integer')
class(`tc_enableAssignmentRulesReordering`) = c("SWIGFunction", class('tc_enableAssignmentRulesReordering'))
...
`tc_COPASI_api` = function(simulateDeterministic, simulateStochastic, simulateHybrid, simulateTauLeap, getSteadyState, steadyStateScan, steadyStateScan2D, getJacobian, getEigenvalues, getUnscaledElasticities, getUnscaledConcentrationCC, getUnscaledFluxCC, getScaledElasticities, getScaledConcentrationCC, getScaledFluxCC, tc_reducedStoichiometry, tc_emf, tc_Lmat, tc_Kmat, calcFlux, calcDeriv, gaoptim, update1, update2, enableAssignmentRulesOrdering)
{
  ...
  if(is.function(calcFlux)) {
    assert('...' %in% names(formals(calcFlux)) || length(formals(calcFlux)) >= 0);
  } else {
    if(is.character(calcFlux)) {
      calcFlux = getNativeSymbolInfo(calcFlux);
    };
    if(is(calcFlux, "NativeSymbolInfo")) {
      calcFlux = calcFlux$address;
    }
  }; 
  if(is.function(calcDeriv)) {
    assert('...' %in% names(formals(calcDeriv)) || length(formals(calcDeriv)) >= 0);
  } else {
    if(is.character(calcDeriv)) {
      calcDeriv = getNativeSymbolInfo(calcDeriv);
    };
    if(is(calcDeriv, "NativeSymbolInfo")) {
      calcDeriv = calcDeriv$address;
    }
  }; 
  if(is.function(gaoptim)) {
    assert('...' %in% names(formals(gaoptim)) || length(formals(gaoptim)) >= 0);
  } else {
  ...
  if(is.function(enableAssignmentRulesOrdering)) {
    assert('...' %in% names(formals(enableAssignmentRulesOrdering)) || length(formals(enableAssignmentRulesOrdering)) >= 0);
  } else {
    if(is.character(enableAssignmentRulesOrdering)) {
      enableAssignmentRulesOrdering = getNativeSymbolInfo(enableAssignmentRulesOrdering);
    };
    if(is(enableAssignmentRulesOrdering, "NativeSymbolInfo")) {
      enableAssignmentRulesOrdering = enableAssignmentRulesOrdering$address;
    }
  }; 
  ;.Call('R_swig_tc_COPASI_api', simulateDeterministic, simulateStochastic, simulateHybrid, simulateTauLeap, getSteadyState, steadyStateScan, steadyStateScan2D, getJacobian, getEigenvalues, getUnscaledElasticities, getUnscaledConcentrationCC, getUnscaledFluxCC, getScaledElasticities, getScaledConcentrationCC, getScaledFluxCC, tc_reducedStoichiometry, tc_emf, tc_Lmat, tc_Kmat, calcFlux, calcDeriv, gaoptim, update1, update2, enableAssignmentRulesOrdering, PACKAGE='tinkercell');
  
}

attr(`tc_COPASI_api`, 'returnType') = 'void'
attr(`tc_COPASI_api`, "inputTypes") = c('_p_f_double_double_int__tc_matrix', '_p_f_double_double_int__tc_matrix', '_p_f_double_double_int__tc_matrix', '_p_f_double_double_int__tc_matrix', '_p_f___tc_matrix', '_p_f_p_q_const__char_double_double_int__tc_matrix', '_p_f_p_q_const__char_double_double_int_p_q_const__char_double_double_int__tc_matrix', '_p_f___tc_matrix', '_p_f___tc_matrix', '_p_f___tc_matrix', '_p_f___tc_matrix', '_p_f___tc_matrix', '_p_f___tc_matrix', '_p_f___tc_matrix', '_p_f___tc_matrix', '_p_f___tc_matrix', '_p_f___tc_matrix', '_p_f___tc_matrix', '_p_f___tc_matrix', '_p_f___tc_matrix', '_p_f___tc_matrix', '_p_f_p_q_const__char__tc_matrix', '_p_f_tc_matrix__void', '_p_f_p_q_const__char_double__void', '_p_f_int__void')
