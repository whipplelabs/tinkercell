...
public class SimpleSpeciesReference extends SBase {
 ...
 public String getSpecies() {
   ...
   * {@link SimpleSpeciesReference}'s 'id' attribute has been set.
   * <p>
...
is the the name of the optional attribute in question.
   ...
   * <p>
   * @return <code>true</code> if the 'id' attribute of this {@link SimpleSpeciesReference} has been
 ...
 public boolean isSetId() {
  ...
  /**
   * Predicate returning <code>true</code> or <code>false</code> depending on whether this
   * {@link SimpleSpeciesReference}'s 'name' attribute has been set.
   * <p>
   * <em>Some words of explanation about the</em>
<code>set</code>/<code>unset</code>/<code>isSet</code> <em>methods</em>:
SBML Levels 1 and 2 define certain attributes on some classes of objects as
...
is the the name of the optional attribute in question.
   ...
   * <p>
   * @return <code>true</code> if the 'name' attribute of this {@link SimpleSpeciesReference} has been
   * set, <code>false</code> otherwise.
   */
