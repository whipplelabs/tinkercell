...
public class ListOfLocalParameters : ListOf {
	private HandleRef swigCPtr;
	
	internal ListOfLocalParameters(IntPtr cPtr, bool cMemoryOwn) : base(libsbmlPINVOKE.ListOfLocalParametersUpcast(cPtr), cMemoryOwn)
	{
  ...
  public override SBase get(long n) {
  ...
  public virtual LocalParameter get(string sid) {
    IntPtr cPtr = libsbmlPINVOKE.ListOfLocalParameters_get__SWIG_2(swigCPtr, sid);
    LocalParameter ret = (cPtr == IntPtr.Zero) ? null : new LocalParameter(cPtr, false);
    return ret;
  }

  public override SBase remove(long n) {
  ...
  public virtual LocalParameter remove(string sid) {
