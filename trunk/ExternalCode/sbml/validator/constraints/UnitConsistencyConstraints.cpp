 ...
 *
 * $Id: UnitConsistencyConstraints.cpp 10131 2009-08-28 12:27:16Z sarahkeating $
 * $HeadURL: https://sbml.svn.sourceforge.net/svnroot/sbml/trunk/libsbml/src/validator/constraints/UnitConsistencyConstraints.cpp $
 */
...
//// repeat of constraints but with different numbers
//// this is for l2v4 where the validation rules were not applicable
//START_CONSTRAINT (90511, AssignmentRule, ar)
//{
//  const string& variable = ar.getVariable();
//  const Compartment* c = m.getCompartment(variable);
//
...
//
//
//START_CONSTRAINT (90512, AssignmentRule, ar)
//{
//  const string& variable = ar.getVariable();
//  const Species * s = m.getSpecies(variable);
//
...
//
//
//START_CONSTRAINT (90513, AssignmentRule, ar)
//{
//  const string& variable = ar.getVariable();
//  const Parameter* p = m.getParameter(variable);
//
...
//
//
//START_CONSTRAINT (90521, InitialAssignment, ia)
//{
//  const string& variable = ia.getSymbol();
//  const Compartment* c = m.getCompartment(variable);
//
...
//
//
//START_CONSTRAINT (90522, InitialAssignment, ia)
//{
//  const string& variable = ia.getSymbol();
//  const Species * s = m.getSpecies(variable);
//
...
//
//
//START_CONSTRAINT (90523, InitialAssignment, ia)
//{
//  const string& variable = ia.getSymbol();
//  const Parameter* p = m.getParameter(variable);
//
...
//
//
//START_CONSTRAINT (90531, RateRule, rr)
//{
//  const string& variable = rr.getVariable();
//  const Compartment* c = m.getCompartment(variable);
//
...
//
//
//START_CONSTRAINT (90532, RateRule, rr)
//{
//  const string& variable = rr.getVariable();
//  const Species* s = m.getSpecies(variable);
//
...
//
//
//START_CONSTRAINT (90533, RateRule, rr)
//{
//  const string& variable = rr.getVariable();
//  const Parameter* p = m.getParameter(variable);
//
...
//
//
//START_CONSTRAINT (90541, KineticLaw, kl)
//{
//  //msg =
//  //  "The units of the 'math' formula in a <kineticLaw> definition must be "
//  //  "the equivalent of _substance per time_. (References: L2V2 Section "
...
//
//
//START_CONSTRAINT (90551, Event, e)
//{
//  //msg =
//  //  "When a value for <delay> is given in a <event> definition, the units of "
//  //  "the delay formula must correspond to either the value of 'timeUnits' in "
...
//
//
//START_CONSTRAINT (90561, EventAssignment, ea)
//{
//  //msg =
//  //  "When the 'variable' in an <eventAssignment> refers to a <compartment>, "
//  //  "the units of the <eventAssignment>'s <math> expression must be consistent "
...
//
//
//START_CONSTRAINT (90562, EventAssignment, ea)
//{
//  //msg =
//  //  "When the 'variable' in an <eventAssignment> refers to a <species>, the "
//  //  "units of the <eventAssignment>'s <math> expression must be consistent "
...
//
//
//START_CONSTRAINT (90563, EventAssignment, ea)
//{
//  //msg =
//  //  "When the 'variable' in an <eventAssignment> refers to a <parameter>, the "
//  //  "units of the <eventAssignment>'s <math> expression must be consistent "
