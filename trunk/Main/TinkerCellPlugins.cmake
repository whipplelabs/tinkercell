...
IF ( WIN32 )
  INSTALL(TARGETS ModelingPlugins DESTINATION ${TINKERCELL_CPP_PLUGINS_FOLDER}  )
ELSE ( WIN32 )
  INSTALL(TARGETS ModelingPlugins LIBRARY DESTINATION ${TINKERCELL_CPP_PLUGINS_FOLDER}   )
ENDIF( WIN32 )
