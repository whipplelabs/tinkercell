...
namespace Tinkercell
{
	/***************************************
	        VISUAL TOOL
	*****************************************/
// 	SimulationEventsTool::VisualTool::VisualTool() : GraphicalTool(tr("Events"))
// 	{
...
// 		item.setToolTip(tr("Events"));
// 		setToolTip(tr("Events"));
//
// 		item.normalize();
...
// 	}
//
// 	void SimulationEventsTool::VisualTool::selected(const QList<QGraphicsItem*>& list)
// 	{
// 		if (editTool != 0)
// 		{
...
// 			if (editTool->parentWidget() != 0)
// 			{
// 				if (editTool->parentWidget()->isVisible())
// 					openedByUser = false;
// 				else
...
// 		visualTool.setMainWindow(main);
	...
	void SimulationEventsTool::sceneClosing(GraphicsScene * , bool *)
	{
		QCoreApplication::setOrganizationName("TinkerCell");
		QCoreApplication::setOrganizationDomain("www.tinkercell.com");
		QCoreApplication::setApplicationName("TinkerCell");
	...
	void SimulationEventsTool::itemsInserted(GraphicsScene* , const QList<QGraphicsItem *>& , const QList<ItemHandle*>& handles)
	{
...
// 				handles[i]->graphicalTools += &visualTool;
	...
	SimulationEventsTool::SimulationEventsTool() : Tool(tr("Events"))//, visualTool()
	{
...
// 	if (main->tools.contains(simulationEventsTool->name))
// 		delete simulationEventsTool;
// 	else
// 		simulationEventsTool->setMainWindow(main);
