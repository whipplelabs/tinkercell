...
FILE( GLOB TINKERCELL_PLUGINS_SET1_SRC 
...
#    ${TINKERCELL_SOURCE_DIR}/ModularNetworkAlgorithms/*.cpp
    ${TINKERCELL_SOURCE_DIR}/Main/Plugins1.cpp
)

FILE( GLOB TINKERCELL_PLUGINS_SET1_HDRS
...
FILE( GLOB TINKERCELL_PLUGINS_SET2_SRC 
    ${TINKERCELL_SOURCE_DIR}/DynamicCodeTools/*.cpp
    ${TINKERCELL_BINARY_DIR}/DynamicCodeTools/*.cpp
    ${TINKERCELL_SOURCE_DIR}/Main/Plugins2.cpp
)

FILE( GLOB TINKERCELL_PLUGINS_SET2_HDRS
    ${TINKERCELL_SOURCE_DIR}/DynamicCodeTools/*.h
)

QT4_WRAP_CPP( TINKERCELL_PLUGINS_SET1_MOC ${TINKERCELL_PLUGINS_SET1_HDRS} )
QT4_WRAP_CPP( TINKERCELL_PLUGINS_SET2_MOC ${TINKERCELL_PLUGINS_SET2_HDRS} )
...
ADD_LIBRARY( ModelingPlugins 
  SHARED
  ${TINKERCELL_PLUGINS_SET1_SRC}
  ${TINKERCELL_PLUGINS_SET1_MOC}
)

ADD_LIBRARY( CodingPlugins 
  SHARED
  ${TINKERCELL_PLUGINS_SET2_SRC}
  ${TINKERCELL_PLUGINS_SET2_MOC}
)

TARGET_LINK_LIBRARIES( CodingPlugins
  CodingPlugins
  TinkerCellCore
  muparser
  copasi
...
IF ( WIN32 )
  INSTALL(TARGETS ModelingPlugins DESTINATION ${TINKERCELL_CPP_PLUGINS_FOLDER} COMPONENT plugins )
  INSTALL(TARGETS CodingPlugins DESTINATION ${TINKERCELL_CPP_PLUGINS_FOLDER} COMPONENT ../bin )
ELSE ( WIN32 )
  INSTALL(TARGETS ModelingPlugins LIBRARY DESTINATION ${TINKERCELL_CPP_PLUGINS_FOLDER} COMPONENT plugins  )
  INSTALL(TARGETS CodingPlugins LIBRARY DESTINATION ${TINKERCELL_CPP_PLUGINS_FOLDER} COMPONENT ../bin   )
ENDIF( WIN32 )
