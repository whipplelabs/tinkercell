...
public class Model : SBase {
  ...
  public ModelHistory getModelHistory() {
    IntPtr cPtr = libsbmlPINVOKE.Model_getModelHistory__SWIG_0(swigCPtr);
  ...
  public bool isSetModelHistory() {
    bool ret = libsbmlPINVOKE.Model_isSetModelHistory(swigCPtr);
    return ret;
  }
  ...
  public int setModelHistory(ModelHistory history) {
    int ret = libsbmlPINVOKE.Model_setModelHistory(swigCPtr, ModelHistory.getCPtr(history));
    return ret;
  }
  ...
  public int unsetModelHistory() {
    int ret = libsbmlPINVOKE.Model_unsetModelHistory(swigCPtr);
    return ret;
  }
  ...
  public Rule getRule(long n) {
	return (Rule) libsbml.DowncastSBase(libsbmlPINVOKE.Model_getRule__SWIG_0(swigCPtr, n), false);
}

  public Rule getRule(string variable) {
	return (Rule) libsbml.DowncastSBase(libsbmlPINVOKE.Model_getRule__SWIG_2(swigCPtr, variable), false);
}
  ...
  public Rule removeRule(long n) {
	return (Rule) libsbml.DowncastSBase(libsbmlPINVOKE.Model_removeRule__SWIG_0(swigCPtr, n), true);
}

  public Rule removeRule(string variable) {
	return (Rule) libsbml.DowncastSBase(libsbmlPINVOKE.Model_removeRule__SWIG_1(swigCPtr, variable), true);
}
