...
public class ListOfSpeciesReferences : ListOf {
  ...
  public new SimpleSpeciesReference get(long n) {
       return (SimpleSpeciesReference) libsbml.DowncastSBase(libsbmlPINVOKE.ListOfSpeciesReferences_get__SWIG_0(swigCPtr, n), false);
}

  public new SimpleSpeciesReference get(string sid) {
       return (SimpleSpeciesReference) libsbml.DowncastSBase(libsbmlPINVOKE.ListOfSpeciesReferences_get__SWIG_2(swigCPtr, sid), false);
}

  public new SimpleSpeciesReference remove(long n) {
       return (SimpleSpeciesReference) libsbml.DowncastSBase(libsbmlPINVOKE.ListOfSpeciesReferences_remove__SWIG_0(swigCPtr, n), true);
}

  public new SimpleSpeciesReference remove(string sid) {
       return (SimpleSpeciesReference) libsbml.DowncastSBase(libsbmlPINVOKE.ListOfSpeciesReferences_remove__SWIG_1(swigCPtr, sid), true);
}
