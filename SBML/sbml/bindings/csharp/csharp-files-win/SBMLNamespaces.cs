...
public class SBMLNamespaces : IDisposable {
  ...
  public long getLevel() { return (long)libsbmlPINVOKE.SBMLNamespaces_getLevel(swigCPtr); }

  public long getVersion() { return (long)libsbmlPINVOKE.SBMLNamespaces_getVersion(swigCPtr); }

  public XMLNamespaces getNamespaces() {
    IntPtr cPtr = libsbmlPINVOKE.SBMLNamespaces_getNamespaces(swigCPtr);
