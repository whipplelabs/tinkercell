...
class libsbmlPINVOKE {
  ...
  public static extern int LocalParameter_setId(HandleRef jarg1, string jarg2);

  [DllImport("libsbmlcs", EntryPoint="CSharp_LocalParameter_setName")]
  public static extern int LocalParameter_setName(HandleRef jarg1, string jarg2);
  ...
  public static extern int LocalParameter_setUnits(HandleRef jarg1, string jarg2);
